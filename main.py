...
def averageMobileNet(i, numAgents, w0, x, vu, u, vd, d, sensingRange, psi, w, mu_k, q, phi, vg, niu_k, v, lamda,
    ...
    for k in range(numAgents):
        if k not in attackers:
            neighbor = findNeighbors(x, k, numAgents, sensingRange)
...
def plotDynamics():
    ...
    for tic in ax5.yaxis.get_major_ticks():
        tic.tick1On = tic.tick2On = False
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax5)
    ...
    for tic in ax4.yaxis.get_major_ticks():
        tic.tick1On = tic.tick2On = False
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax4)
...
if __name__ == '__main__':
    ...
    for tic in ax00.yaxis.get_major_ticks():
        tic.tick1On = tic.tick2On = False
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax00)
    ...
    for tic in ax0.yaxis.get_major_ticks():
        tic.tick1On = tic.tick2On = False
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax0)
    plot_point_set(x_no, color='b', ax=ax0)
    if attackers:
        for i in attackers:
    ...
    for tic in ax1.yaxis.get_major_ticks():
        ...
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax1)
    plot_point_set(x_avg, color='b', ax=ax1)
    if attackers:
        for i in attackers:
    ...
    for tic in ax2.yaxis.get_major_ticks():
        ...
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax2)
    plot_point_set(x_co, color='b', ax=ax2)
    if attackers:
        for i in attackers:
            plot_point(x_co[i], color='r', ax=ax2)
    # ax2.set_title(r'(b)')
    ...
    for tic in ax3.yaxis.get_major_ticks():
        ...
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax3)
    plot_point_set(x_GM, color='b', ax=ax3)
    if attackers:
        for i in attackers:
            plot_point(x_GM[i], color='r', ax=ax3)
    # ax3.set_title(r'(c)')
    ...
    for tic in ax4.yaxis.get_major_ticks():
        ...
        tic.label1On = tic.label2On = False
    plot_point(w0, marker='*', color='chartreuse', size=12, ax=ax4)
    plot_point_set(x_center, color='b', ax=ax4)
    if attackers:
        for i in attackers:
            plot_point(x_center[i], color='r', ax=ax4)
    # ax4.set_title(r'(d)')
    ...
    plt.plot(10 * np.log10(MSE_x_no[1:]), label=r'Noncoop-SGD')
